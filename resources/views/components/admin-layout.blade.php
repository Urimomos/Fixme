            ...
            <nav x-data="{ open: false }" class="bg-gray-800 text-white shadow-lg">
                <div class="container mx-auto px-6">
                    <div class="flex justify-between items-center h-16">
                        ...
                        <div class="hidden md:flex items-center space-x-4">
                             ...
                             <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700">
                            ...
                            <a href="{{ route('admin.users.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700">
                            ...
                            <div x-data="{ devicesOpen: false }" class="relative">
                                ...
                                <div x-show="devicesOpen" @click.away="devicesOpen = false" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-20" style="display: none;">
                                    ...
                                    <a href="{{ route('admin.repair-types.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Tipo de Reparacion</a>
                                </div>
                            </div>
                            <a href="#" class="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700">
                                <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z"></path></svg>
                ...
                <div x-show="open" class="md:hidden">
                    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700">
                        ...
                        <a href="{{ route('admin.users.index') }}" class="flex items-center px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700">
                        ...
                        <a href="#" class="flex items-center px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700">
                           <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z"></path></svg>
                            <span>Promociones</span>
                        </a>
