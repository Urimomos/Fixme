        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2">
                    ...
                    <li><a href="#" class="hover:text-white transition-colors">Marcas que reparamos</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2">
                    <li><p>Av. Siempre Viva 742, Springfield</p></li>
                    <li><a href="tel:+525512345678" class="hover:text-white transition-colors">55-1234-5678</a></li>
                    <li><a href="mailto:contacto@fixme.com" class="hover:text-white transition-colors">contacto@fixme.com</a></li>
                    <li><p>Lun - Vie: 9:00 - 18:00</p></li>
                </ul>
            </div>
        </div>
